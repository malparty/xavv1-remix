...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_SYM] = LAYOUT_split_3x6_3(
            KC_NO, KC_LCBR, KC_AMPR, KC_ASTR, KC_MINS, KC_RCBR,                    TO(_GAME), TO(_GAME),   TO(_GAME), TO(_GAME), DF(_BASE), KC_NO,
    ...
    [_GAME] = LAYOUT_split_3x6_3(
        ...
        KC_NO, KC_NO, KC_A, KC_S, KC_D, KC_F,                 KC_NO, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_NO, 
